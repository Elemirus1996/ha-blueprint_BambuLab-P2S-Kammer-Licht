...
Home-Assistant-Blueprint für die **Bambu Lab Integration**.
...
- Optional: **zusätzliche Warnleuchte** mit Farbe und Blinkintervall
...
## HACS
Dieses Repository ist als Custom Repository vorbereitet. Falls HACS den Blueprint dennoch nicht sauber erkennt, nutze bitte den direkten Blueprint-Import-Link oben — der ist für Blueprints in der Praxis meist zuverlässiger.
