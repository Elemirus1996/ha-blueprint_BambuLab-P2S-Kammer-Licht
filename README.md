...
## Wichtige Änderung
Die Fehler-Sensoren werden als **Liste mehrerer Diagnose-Sensoren** konfiguriert. Dadurch werden keine leeren optionalen Entity-IDs mehr als Trigger verwendet.
